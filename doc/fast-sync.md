...
In MWC, we call "sync" the process of synchronizing a new node or a node that
...
by other blockchains, but this is problematic for MWC as it typically does not
download full blocks.

In short, a fast-sync in MWC does the following:
