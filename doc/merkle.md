...
A design goal of MWC is that all structures be as easy to implement and
...
are simple to specify (no scripts) and MWC is written in a language with
...
MWC itself does not need proof-of-spentness but it is a good thing to support
