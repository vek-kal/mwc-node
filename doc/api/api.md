...
This endpoint requires, by default, [Basic Authentication](https://en.wikipedia.org/wiki/Basic_access_authentication). The username is `mwcmain` (mainnet), `mwcfloo` (testnet), `mwc` (usernet).
...
- [Owner API](https://mwcproject.github.io/Node/grin_api/trait.OwnerRpc.html)
- [Foreign API](https://mwcproject.github.io/Node/grin_api/trait.ForeignRpc.html)
